    ...
    <BCard style="min-height: 10em;">
      ...
      <BCardBody>
        <div>
          ...
          <div class="row mb-3">
            <div class="col-4">
              <div><input type="checkbox" class="form-cotrol"> Date</div>
              <div><input type="checkbox" class="form-cotrol"> Nom & prenoms</div>
              <div><input type="checkbox" class="form-cotrol"> CNI</div>
            </div>

            <div class="col-4">
              <div><input type="checkbox" class="form-cotrol"> Code visite</div>
              <div><input type="checkbox" class="form-cotrol"> Code Visiteur</div>
              <div><input type="checkbox" class="form-cotrol"> Société</div>
            </div>
            <div class="col-4">
              <div><input type="checkbox" class="form-cotrol"> Employé</div>
              <div><input type="checkbox" class="form-cotrol"> Heure entrée</div>
              <div><input type="checkbox" class="form-cotrol"> Heure sortie</div>
              <div><input type="checkbox" class="form-cotrol"> Type Visite</div>
            </div>
          </div>
